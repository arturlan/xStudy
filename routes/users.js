...
var renderingHtml = function(obj) {
    ...
    var css = '#login {text-align: right; } #header {margin-top: 30px;} h1, h5, h3 {font-family: "Libre Franklin", sans-serif;} body{ background-color: #A2AB58;} a { color: white; } code, pre {background-color: #CB8C1D;}';
    ...
    var middle = '<div class="row" id="header"><div class="col-xs-6 col-md-6"></div><div class="col-xs-2 col-md-2"></div><div class="col-xs-1 col-md-1"><a href="/users/28/yourlist" style="text-decoration:none; color:white">Your list</a></div><div class="col-xs-1 col-md-1" id="signup"><a href="/users/28/addtolist" style="text-decoration:none; color: white">Add to list</a></div><div class="col-xs-1 col-md-1" id="login"><p style="color: red">Bill Murray</p></div><div class="col-xs-1 col-md-1" id="signup"><a href="/" style="text-decoration:none">Log out</a></div></div><div class="row"><div class="col-xs-1 col-md-3"></div><div class="col-xs-10 col-md-6" id="logo"><img src="/images/logo.png" class="img-responsive center-block"></div><div class="col-xs-1 col-md-3"></div></div><div class="row"><div class="col-xs-1 col-md-3"></div><div class="col-xs-10 col-md-6"><form name="test" method="post" action="/users/signedin"><input type="text" class="form-control" placeholder="Text input" name="query"></form></div><div class="col-xs-1 col-md-3"></div></div>'
